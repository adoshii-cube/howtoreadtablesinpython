...
filesname=pd.read_csv('D:\\WinPython-64bit-2.7.6.4\\PDF to Table\\filespath101.csv')
...
columns= ["Name_Path","Email_Address","Mobile_Number","YOB","Address_PIN","District","State","Is_Post_Graduate","Is_Graduate","Post_Graduate_details","Graduate_details","Post_Graduate_details_key","Graduate_details_key","Post_Graduate_College","Graduate_College","PG_percentage","Graduate_percentage","PG_Univ_Tier","Graduate_Univ_Tier","Banking_Role","Circle","Region","City","excel","is_ed_table","Post_Graduate_College_Score","Graduate_College_Score","Post_Graduate_College_text","Graduate_College_text","Is_Bank","Graduate_Parttime","Post_Graduate_Parttime","Age","Years_Experience","Is_sales","Check_Pin"]	
...
for i in range(0,len(filesname)): 
	...
	string_to_search= re.sub(' +',' ',string_to_search) # remove space SK
